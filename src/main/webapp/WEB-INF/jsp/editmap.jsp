...
function updateItems(){
	...
	document.itemsForm.action="${pageContext.request.contextPath }/item/editMapSubmit.action";
...
<tr>
	<td><input type="text" name="itemsInfo['${s.index}'].name" value="${item.name }"/></td>
	<td><input type="text" name="itemsInfo['${s.index }'].price" value="${item.price }"/></td>
